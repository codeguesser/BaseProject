...
#define MB_TEXTSIZE(text, font) [text length] > 0 ? ([[[UIDevice currentDevice] systemVersion] floatValue]>=7.0?[text \
sizeWithAttributes:@{NSFontAttributeName:font}]:[text sizeWithFont:font]) : CGSizeZero;
